...
class FirmwareBuilder:
    ...
    def build_bootloader(self):
        ...
        # 构建bootloader
        cmd = ["mbed", "compile", "-t", "GCC_ARM", "-m", "NUCLEO_F429ZI", "--profile", "release"]
        result = self.run_command(cmd, cwd=self.bootloader_dir)
        
        # 检查bootloader二进制文件是否生成
        bootloader_bin = self.bootloader_dir / "BUILD" / "NUCLEO_F429ZI" / "GCC_ARM-RELEASE" / "slave_bootloader.bin"
    ...
    def build_application(self):
        ...
        # 检查应用程序二进制文件是否生成
        app_bin = self.application_dir / "BUILD" / "NUCLEO_F429ZI" / "GCC_ARM-RELEASE" / "slave.bin"
        if app_bin.exists():
    ...
    def copy_binaries(self):
        ...
        # 复制bootloader
        bootloader_src = self.bootloader_dir / "BUILD" / "NUCLEO_F429ZI" / "GCC_ARM-RELEASE" / "slave_bootloader.bin"
        ...
        # 复制应用程序
        app_src = self.application_dir / "BUILD" / "NUCLEO_F429ZI" / "GCC_ARM-RELEASE" / "slave.bin"
        ...
        # 复制完整固件（如果存在）
        full_firmware_src = self.application_dir / "BUILD" / "NUCLEO_F429ZI" / "GCC_ARM-RELEASE" / "slave.hex"

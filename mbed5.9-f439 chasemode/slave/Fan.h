...
public:
	...
	bool updateChase(float tolerance);
...
private:
	...
	// PI Controller variables for chase feedback:
	float kp;				// Proportional gain
	float ki;				// Integral gain
	float integral;			// Integral accumulator
	float lastError;		// Previous error for derivative calculation
	bool chasing;			// Whether fan is in chase mode
	Timer chaseTimer;		// Timer for PI control loop timing

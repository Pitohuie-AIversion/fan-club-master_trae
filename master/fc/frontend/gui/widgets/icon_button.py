...
class IconButton(ttk.Frame):
    ...
    def __init__(
        self, master, text="", icon=None, command=None, style="Secondary", **kwargs
    ):
        ...
        self.button = ttk.Button(self, text=text, command=command, style=button_style)
        ...
        try:
            ...
            if cached_icon:
                ...
                icon_img = create_simple_icon(
                    self.icon_name, size=(16, 16), color=color
                )
            ...
            if self.text:
                self.button.config(
                    image=self.icon_image, text=self.text, compound=tk.LEFT
                )
            else:
...
def create_icon_button(
    master, text="", icon=None, command=None, style="Secondary", **kwargs
):
    """
    ...
    """
    return IconButton(
        master, text=text, icon=icon, command=command, style=style, **kwargs
    )
...
def create_play_button(master, command=None, **kwargs):
    ...
    return create_icon_button(
        master, text="Play", icon="play", command=command, style="Primary", **kwargs
    )
...
def create_pause_button(master, command=None, **kwargs):
    ...
    return create_icon_button(
        master, text="Pause", icon="pause", command=command, style="Secondary", **kwargs
    )
...
def create_stop_button(master, command=None, **kwargs):
    ...
    return create_icon_button(
        master, text="Stop", icon="stop", command=command, style="Secondary", **kwargs
    )
...
def create_step_button(master, command=None, **kwargs):
    ...
    return create_icon_button(
        master, text="Step", icon="step", command=command, style="Secondary", **kwargs
    )
...
def create_apply_button(master, command=None, **kwargs):
    ...
    return create_icon_button(
        master, text="Apply", icon="apply", command=command, style="Primary", **kwargs
    )
...
def create_print_button(master, command=None, **kwargs):
    ...
    return create_icon_button(
        master, text="Print", icon="print", command=command, **kwargs
    )
...
def create_load_button(master, command=None, **kwargs):
    ...
    return create_icon_button(
        master, text="Load", icon="load", command=command, **kwargs
    )
...
def create_save_button(master, command=None, **kwargs):
    ...
    return create_icon_button(
        master, text="Save", icon="save", command=command, **kwargs
    )
...
def create_help_button(master, command=None, **kwargs):
    ...
    return create_icon_button(
        master, text="Help", icon="help", command=command, style="Secondary", **kwargs
    )

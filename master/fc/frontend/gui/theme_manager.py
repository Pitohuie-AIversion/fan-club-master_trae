        ...
        try:
            ...
            try:
                ...
                style.map(
                    ...
                    foreground=[["selected", self.get_color("TEXT_ON_PRIMARY")]],
                )
            except (tk.TclError, AttributeError, RuntimeError):
                pass
            ...
            try:
                ...
                style.configure(
                    "TProgressbar", background=accent, troughcolor=surface_3
                )
            ...
            try:
                style.configure(
                    "ErrorBanner.TLabel",
                    background=self.get_color("ERROR_MAIN"),
                    foreground=self.get_color("TEXT_ON_DARK"),
                    padding=(10, 6),
            ...
            try:
                style.configure(
                    "Secondary.TLabel", background=base_bg, foreground=fg_muted
                )
                style.configure(
                    "Warning.TLabel",
                    background=base_bg,
                    foreground=self.get_color("WARNING_MAIN"),
                )
                style.configure("Surface3.TLabel", background=surface_3, foreground=fg)
                style.configure(
                    "Splash.TLabel", background=base_bg, foreground=fg, borderwidth=0
                )

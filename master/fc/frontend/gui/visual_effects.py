...
class GradientFrame(tk.Frame):
    ...
    def __init__(
        self, parent, gradient_colors: Tuple[str, str], direction="vertical", **kwargs
    ):
        ...
        if self.direction == "vertical":
            ...
            for i in range(steps):
                ...
                self.canvas.create_rectangle(
                    0, y1, width, y2, fill=color, outline=color, tags="gradient"
                )
        else:  # horizontal
...
class ShadowMixin:
    ...
    def _setup_shadow(self):
        ...
        self.shadow_frame = tk.Frame(
            self.master, bg=self.shadow_color, height=2, relief="flat", bd=0
        )
    ...
    def update_shadow(self, blur=None, offset=None, color=None):
        ...
        if hasattr(self, "shadow_frame"):
            ...
            self.shadow_frame.place(x=self.shadow_offset[0], y=self.shadow_offset[1])
...
class GradientButton(tk.Button, InteractiveWidget):
    ...
    def _setup_gradient_background(self):
        ...
        self.gradient_canvas = tk.Canvas(
            self, highlightthickness=0, height=self.winfo_reqheight() or 30
        )
    ...
    def _draw_button_gradient(self, event=None):
        ...
        for i in range(steps):
            ...
            self.gradient_canvas.create_rectangle(
                0, y1, width, y2, fill=color, outline=color
            )
...
class VisualEffectsManager:
    ...
    def create_gradient_frame(self, parent, gradient_type="primary", **kwargs):
        ...
        gradient_schemes = {
            ...
            "surface": (
                theme_manager.get_color("SURFACE_1"),
                theme_manager.get_color("SURFACE_2"),
            ),
